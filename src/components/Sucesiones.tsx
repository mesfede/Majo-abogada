      ...
      <div className="max-w-[1280px] mx-auto px-6 md:px-16 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-12 lg:items-center">
          ...
          >
            ...
            <p className="font-sans text-lg md:text-xl font-light text-neutral-600 leading-[1.8] text-left max-w-2xl border-l-4 border-[#0a2240]/10 pl-5">
            ...
            <div className="flex flex-col space-y-4 pt-4">
              <div className="group flex items-center gap-4 p-3 md:p-4 rounded-xl bg-white/70 backdrop-blur-sm border border-brand-primary/5 shadow-sm hover:shadow-md hover:bg-brand-gold-light/20 hover:border-brand-gold/30 transition-all duration-300 cursor-default">
                <div className="p-2.5 bg-neutral-100/80 group-hover:bg-white/60 rounded-lg text-brand-gold group-hover:text-[#0a2240] border border-brand-primary/5 transition-colors">
                  <Landmark className="w-5 h-5" />
                </div>
                <div>
                  <h4 className="font-sans text-[13px] font-bold text-brand-primary group-hover:text-[#0a2240] mb-0.5 uppercase tracking-wider transition-colors">
                    Sucesiones Testamentarias
                  </h4>
                  <p className="font-sans text-[13px] text-neutral-500 group-hover:text-[#0a2240]/80 leading-snug transition-colors">
